...
const BUILTIN_SKILLS: AgentSkill[] = [
  ...
  },
  {
    ...
    version: '1.0.0',
    appliesTo: ['executor'],
    requiredCapabilities: ['file.read', 'grep.search', 'diff.read', 'file.write', 'file.patch', 'task.run'],
  ...
  },
  {
    ...
    version: '1.0.0',
    appliesTo: ['reviewer'],
    requiredCapabilities: ['file.read', 'grep.search', 'diff.read'],
  ...
  },
  {
    ...
    version: '1.0.0',
    appliesTo: ['explorer'],
    requiredCapabilities: ['file.glob', 'file.list', 'file.read', 'grep.search'],
    permissionHints: ['none'],
