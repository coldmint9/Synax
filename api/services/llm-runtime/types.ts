...
export interface LlmGatewayRequest {
  ...
  /** Saved marker-free prefix identity for the previous runtime reminder. */
  previousHistoryAnchor?: { version: 1; fingerprint: string };
  /** Internal pre-dispatch hook; never serialized or forwarded as provider options. */
  onRequestPrepared?: (prepared: {
    messages: LlmGatewayMessage[];
    historyAnchor: { version: 1; fingerprint: string };
    historyAnchorStatus: "cold" | "matched" | "changed" | "evicted";
  }) => void | Promise<void>;
  /** Request provenance for opt-in, body-free cache diagnostics. */
  cacheDiagnosticsContext?: {
    requestId: string;
    source: "main" | "subsession" | "auxiliary";
    phase: "cold" | "continuous" | "post-compaction";
  };
