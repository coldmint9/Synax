...
export const ProjectImportStateSchema = z.enum([
  "idle",
  "syncing",
  "ready",
  "failed",
...
export type CreateProjectFromRepoRequest = z.infer<
  typeof CreateProjectFromRepoRequestSchema
>;
...
export type CreateProjectFromScratchRequest = z.infer<
  typeof CreateProjectFromScratchRequestSchema
>;
