...
export const ActivityRow = memo(function ActivityRow({
  ...
  const heading = (
    <>
      ...
      {meta && (
        <span className="bui-activity-meta" title={meta}>
          {meta}
        </span>
      )}
      {preview && !isOpen && (
        <span className="bui-activity-preview">{preview}</span>
      )}
      {interactive &&
        (isOpen ? (
      ...
      {isOpen && hasBody ? (
        ...
        <div className="bui-activity-reveal">
          ...
          >
            {bodyContent ?? body}
            {footnote ? (
              <div className="bui-activity-footnote">{footnote}</div>
            ) : null}
          </div>
        </div>
      ) : null}
