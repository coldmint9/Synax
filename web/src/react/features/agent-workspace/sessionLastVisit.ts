import { sessionPath, sessionsPath, newSessionPath } from "./sessionRoutes";
...
export function loadSessionLastVisit(
  projectId: string,
): SessionLastVisit | null {
...
export function saveSessionLastVisit(
  projectId: string,
  visit: SessionLastVisit,
): void {
...
export function sessionLastVisitPath(
  projectId: string,
  visit: SessionLastVisit,
): string {
