...
> = {
  boundary: {
    titleKey: "agentPermTierBoundary",
    descKey: "agentPermTierBoundaryDesc",
  },
  auto: {
    titleKey: "agentPermTierAuto",
    descKey: "agentPermTierAutoDesc",
  },
  unrestricted: {
    titleKey: "agentPermTierUnrestricted",
    descKey: "agentPermTierUnrestrictedDesc",
  },
};
