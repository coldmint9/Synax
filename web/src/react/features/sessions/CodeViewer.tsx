  ...
  return (
    <div className="code-viewer flex min-h-0 flex-1 flex-col">
      <div className="flex shrink-0 items-center gap-1.5 border-b border-border/30 bg-secondary/20 px-2.5 py-1.5">
        ...
        {canPreview && (
          <div className="flex shrink-0 gap-0.5 rounded bg-secondary/40 p-0.5" role="group" aria-label="文件查看模式">
      ...
      <div className={`code-viewer-body session-workspace-scroll min-h-0 flex-1 ${showPreview && language === 'html' ? 'flex flex-col overflow-hidden' : 'overflow-auto'}`}>
        {loading ? (
