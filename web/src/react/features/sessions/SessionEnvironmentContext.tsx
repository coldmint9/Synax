...
const SessionEnvironmentContext = createContext<SessionEnvironmentValue | null>(null)
 ...
 */
export function useSessionWorkspaceEnvironment(sessionId: string | null): SessionEnvironmentValue {
